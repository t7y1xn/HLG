...
if __name__ == "__main__":
    ...
    modelPath = rootPath + "../../../data/preprocess/word2vectormodel/dim200Window5Min1.model"
    vocabularyPath = rootPath + "../../../data/preprocess/wordVectorVocabulary/dim200Window5Min1Vocabulary"
    word2VecOrgPath = rootPath + "../../../data/preprocess/word2VecOrgPath/dim200Window5Min1Word2VecOrgPath"
