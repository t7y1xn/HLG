...
if __name__ == "__main__":
    ...
    #对训练语料和测试语料进行分词
    #"""
    file_path = "/home/chi/Documents/weibo_cluster/1"
    segment_file_path = "/home/chi/Documents/weibocluster_segmentByPynlpir/1_segment.txt"
    pynlpir.open()    
...
training_file = rootPath + "../../../data/preprocess/PART_II_segment.txt"
after_filter_file = rootPath + "../../../data/preprocess/PART_II_segment_filter.txt"
sparseswords.filterTrainingFile(training_file, after_filter_file)
'''

'''
#test the method of calculate() for count word frequency
data_file = rootPath + "/../../../data/preprocess/PART_II_segment_filter.txt"
statistical_result_file = rootPath + "/../../../data/preprocess/PART_II_segment_calculate.txt"
sparse_word_file = rootPath + "/../../../data/preprocess/PART_II_segment_sparsewordfile.txt"
...
sparseWordFile = rootPath + "/../../../data/preprocess/PART_II_segment_sparsewordfile.txt"
originalFile = rootPath + "/../../../data/preprocess/PART_II_segment_filter.txt"
afterReplaceFile = rootPath + "/../../../data/preprocess/PART_II_segment_replace.txt"
